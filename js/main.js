...
gameScene.preload = function ()
{
    ...
    this.load.image('treeEmpty', 'assets/images/treeEmpty.png');
    this.load.image('emptyH', 'assets/images/emptyH.png');
    this.load.image('textBoxSwitches', 'assets/images/textBoxBoulders.png');
    this.load.image('textBoxCrack', 'assets/images/textBoxCrack.png');
    this.load.image('textBoxSandsLeft', 'assets/images/textBoxSandsLeft.png');
    this.load.image('textBoxSandsRight', 'assets/images/textBoxSandsRight.png');
...
gameScene.create = function ()
{
    ...
    this.tree1 = this.physics.add.image(860, 1115, 'treeEmpty').setOrigin(0);
    this.tree2 = this.physics.add.image(1382, 1115, 'treeEmpty').setOrigin(0);
    this.tree3 = this.physics.add.image(860, 1285, 'treeEmpty').setOrigin(0);
    this.tree4 = this.physics.add.image(1382, 1285, 'treeEmpty').setOrigin(0);
    
    //adds cursor keys
    this.cursors = this.input.keyboard.createCursorKeys();
    
    //textBoxes
    this.tb1 = this.physics.add.image(400, 1030, 'textBoxSwitches');
    this.tb2 = this.physics.add.image(1900, 1030, 'textBoxCrack');
    ...
    this.physics.add.collider(this.tree1, this.player);
    this.physics.add.collider(this.tree2, this.player);
    this.physics.add.collider(this.tree3, this.player);
    this.physics.add.collider(this.tree4, this.player);
    ...
    this.tree1.body.immovable = true;
    this.tree2.body.immovable = true;
    this.tree3.body.immovable = true;
    this.tree4.body.immovable = true;
...
gameScene.openDoor = function(){
    if (keysCollected >=3){
       ...
       this.tb3 = this.physics.add.image(950, 1035, 'textBoxSandsLeft');
       this.tb3.setScale(0.9);
       this.tb4 = this.physics.add.image(1340, 1035, 'textBoxSandsRight');
       this.tb4.setScale(0.9);
